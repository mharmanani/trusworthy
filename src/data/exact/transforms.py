...
#
#    norm: NormConfig = field(default_factory=True)
...
class TransformA224(TransformV3):
    def __init__(
        self,
        norm: Callable = Normalize(),
        tensor_transform: Optional[Callable] = None,
...
class TransformA192(TransformV3):
    def __init__(
        self,
        norm: Callable = Normalize(),
        tensor_transform: Optional[Callable] = None,
        ...
        self.normalize = norm
        self.out_size = (192, 192)
        self.tensor_transform = tensor_transform
        self.us_augmentation = us_augmentation
        self.to_tensor = ToTensor(self.out_size)

class TransformA100(TransformV3):
    def __init__(
        self,
        norm: Callable = Normalize(),
        tensor_transform: Optional[Callable] = None,
        ...
        self.normalize = norm
        self.out_size = (100, 100)
        self.tensor_transform = tensor_transform
        self.us_augmentation = us_augmentation
        self.to_tensor = ToTensor(self.out_size)

class TransformA64(TransformV3):
    def __init__(
        self,
        norm: Callable = Normalize(),
        tensor_transform: Optional[Callable] = None,
